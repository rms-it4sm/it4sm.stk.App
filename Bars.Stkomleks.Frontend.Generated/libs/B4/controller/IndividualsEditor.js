Ext.define('B4.controller.IndividualsEditor', {
    extend: 'B4.base.form.Controller',
    models: [
        'IndividualsEditorModel'],
    views: [
        'IndividualsEditor'],
    requires: [
        'B4.aspects.Permission',
        'B4.view.IndividualsEditor'],
    aspects: [{
        'permissions': [],
        'xtype': 'permissionaspect'
    }],
    // алиас контролируемых представлений
    viewAlias: 'rms-individualseditor',
    viewUid: '2efed10a-d54e-46b9-ac19-6b9792c2fb9e',
    viewDataModel: 'IndividualsEditorModel',
    viewDataController: 'IndividualsEditor',
    viewDataName: 'IndividualsEditor',
    init: function() {
        var me = this;
