namespace Bars.Stkomleks.Mappings
{
    ...
    /// <summary>
    /// Мапинг сущности Единицы измерения
    /// </summary>
    public class UnitMeasureMap : ClassMapping<Bars.Stkomleks.UnitMeasure>
    {
        /// <summary>
        /// Конструктор
        /// </summary>
...
#region Class: UnitMeasure
Property(x => x.Nema, p => { p.Column(col => { col.Name("NEMA");});});
Property(x => x.CutName, p => { p.Column(col => { col.Name("CUTNAME");});});
#endregion
        }
    }
