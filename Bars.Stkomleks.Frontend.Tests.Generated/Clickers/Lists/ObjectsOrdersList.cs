...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Объекты.Заказа
    /// </summary>       
    [Display("Кликер списка [Объекты.Заказа]")]
    [Display("Список [Объекты.Заказа]")]
    public class ObjectsOrdersListClicker : WebElementClicker<ObjectsOrdersListPageObject>
    {          
        public ObjectsOrdersListClicker(AbstractWebDriverTest test, ObjectsOrdersListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Объекты.Заказа]", 
    () => 
    {
