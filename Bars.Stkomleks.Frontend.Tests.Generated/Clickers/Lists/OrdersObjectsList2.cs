...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Объекты
    /// </summary>       
    [Display("Кликер списка [Объекты]")]
    [Display("Список [Объекты]")]
    public class OrdersObjectsList2Clicker : WebElementClicker<OrdersObjectsList2PageObject>
    {          
        public OrdersObjectsList2Clicker(AbstractWebDriverTest test, OrdersObjectsList2PageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Объекты]", 
    () => 
    {
