...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Программы.Организация
    /// </summary>       
    [Display("Кликер списка [Программы.Организация]")]
    [Display("Список [Программы.Организация]")]
    public class OrganizationFundingProgramsListClicker : WebElementClicker<OrganizationFundingProgramsListPageObject>
    {          
        public OrganizationFundingProgramsListClicker(AbstractWebDriverTest test, OrganizationFundingProgramsListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Программы.Организация]", 
    () => 
    {
