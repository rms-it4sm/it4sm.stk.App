...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Виды должностей
    /// </summary>       
    [Display("Кликер списка [Виды должностей]")]
    [Display("Список [Виды должностей]")]
    public class PositionsTypesListClicker : WebElementClicker<PositionsTypesListPageObject>
    {          
        public PositionsTypesListClicker(AbstractWebDriverTest test, PositionsTypesListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Виды должностей]", 
    () => 
    {
