...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Типы документов
    /// </summary>       
    [Display("Кликер списка [Типы документов]")]
    [Display("Список [Типы документов]")]
    public class DocumentsTypeListClicker : WebElementClicker<DocumentsTypeListPageObject>
    {          
        public DocumentsTypeListClicker(AbstractWebDriverTest test, DocumentsTypeListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Типы документов]", 
    () => 
    {
