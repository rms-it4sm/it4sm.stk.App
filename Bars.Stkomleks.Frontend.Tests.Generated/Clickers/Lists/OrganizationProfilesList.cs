...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Профили.Организация
    /// </summary>       
    [Display("Кликер списка [Профили.Организация]")]
    [Display("Список [Профили.Организация]")]
    public class OrganizationProfilesListClicker : WebElementClicker<OrganizationProfilesListPageObject>
    {          
        public OrganizationProfilesListClicker(AbstractWebDriverTest test, OrganizationProfilesListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Профили.Организация]", 
    () => 
    {
