...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Класс-кликер, содержащий код для обхода списка Виды работ
    /// </summary>       
    [Display("Кликер списка [Виды работ]")]
    [Display("Список [Виды работ]")]
    public class WorksTypesListClicker : WebElementClicker<WorksTypesListPageObject>
    {          
        public WorksTypesListClicker(AbstractWebDriverTest test, WorksTypesListPageObject view) : base(test, view) {}

        public override void Run()
        {
            Group("Проверяем представление [Виды работ]", 
    () => 
    {
