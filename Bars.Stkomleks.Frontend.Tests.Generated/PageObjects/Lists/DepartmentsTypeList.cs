...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Виды подразделений' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-departmentstypelist")]
    [Display("Список [Виды подразделений]")]
    public class DepartmentsTypeListPageObject : BarsUpGeneratedListView<DepartmentsTypeListModel>
    {  
        public DepartmentsTypeListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public DepartmentsTypeListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=5d4cc514-7ad2-46ee-9166-738c996f5b31]");
