...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Виды работ' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-workstypeslist")]
    [Display("Список [Виды работ]")]
    public class WorksTypesListPageObject : BarsUpGeneratedListView<WorksTypesListModel>
    {  
        public WorksTypesListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public WorksTypesListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=35d23095-4824-45ee-b3dc-30d4d6990bb8]");
