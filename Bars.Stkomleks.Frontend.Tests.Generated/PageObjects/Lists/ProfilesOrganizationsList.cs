...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Профили организаций' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-profilesorganizationslist")]
    [Display("Список [Профили организаций]")]
    public class ProfilesOrganizationsListPageObject : BarsUpGeneratedListView<ProfilesOrganizationsListModel>
    {  
        public ProfilesOrganizationsListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public ProfilesOrganizationsListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=8533a44a-5ee1-4873-b9d2-bfb1924951da]");
