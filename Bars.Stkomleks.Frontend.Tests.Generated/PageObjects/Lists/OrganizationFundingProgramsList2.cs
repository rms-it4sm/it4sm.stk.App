...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Оганизации.Программа финансирования' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-organizationfundingprogramslist2")]
    [Display("Список [Оганизации.Программа финансирования]")]
    public class OrganizationFundingProgramsList2PageObject : BarsUpGeneratedListView<OrganizationFundingProgramsList2Model>
    {  
        public OrganizationFundingProgramsList2PageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public OrganizationFundingProgramsList2PageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=38a10156-9bd6-4e7f-9a3c-185406e1d0dc]");
