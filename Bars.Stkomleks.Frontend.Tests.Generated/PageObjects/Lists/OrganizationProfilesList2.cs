...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Организации по профилю.Выбор' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-organizationprofileslist2")]
    [Display("Список [Организации по профилю.Выбор]")]
    public class OrganizationProfilesList2PageObject : BarsUpGeneratedListView<OrganizationProfilesList2Model>
    {  
        public OrganizationProfilesList2PageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public OrganizationProfilesList2PageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=1e6d02dd-88ff-4d15-b40c-cfed76e7656f]");
