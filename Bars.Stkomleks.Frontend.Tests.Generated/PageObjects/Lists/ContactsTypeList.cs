...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Типы контактов' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-contactstypelist")]
    [Display("Список [Типы контактов]")]
    public class ContactsTypeListPageObject : BarsUpGeneratedListView<ContactsTypeListModel>
    {  
        public ContactsTypeListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public ContactsTypeListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=3a89ccd8-3bb5-4757-8b07-7c1ab0befcb0]");
