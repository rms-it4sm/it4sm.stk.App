...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Единицы измерения' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-unitmeasurelist")]
    [Display("Список [Единицы измерения]")]
    public class UnitMeasureListPageObject : BarsUpGeneratedListView<UnitMeasureListModel>
    {  
        public UnitMeasureListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public UnitMeasureListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=063719d8-c8f5-43c5-b5d3-ce3eee2566d8]");
