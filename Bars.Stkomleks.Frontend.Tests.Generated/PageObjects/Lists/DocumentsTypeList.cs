...
using Bars.Stkomleks.Frontend;
    ...
    /// <summary>    
    /// Описание реестра 'Типы документов' для ui-тестирования
    /// </summary>       
    [ExtJsXType("rms-documentstypelist")]
    [Display("Список [Типы документов]")]
    public class DocumentsTypeListPageObject : BarsUpGeneratedListView<DocumentsTypeListModel>
    {  
        public DocumentsTypeListPageObject(ExtJsComponent initializer, string elementId) : base(initializer, elementId) {}

        public DocumentsTypeListPageObject(WebDriverAbstractFixture context, string elementId, ExtJsComponent initializer = null) : base(context, elementId, initializer) {}
...
public class Toolbar_Верхняя_панель : ExtJsToolbar {
    ...
    protected override void Initialize() {
        base.Initialize();
        Обновить = Down<ExtJsButton>("[rmsUid=d5b45409-c91f-42be-b98a-4c193138ba78]");
