namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class ObjectsOrdersEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.ObjectsOrders, ObjectsOrdersEditorModel>,  IObjectsOrdersEditorService
    {                

        public ObjectsOrdersEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "ObjectsOrdersEditor";
    }
}
