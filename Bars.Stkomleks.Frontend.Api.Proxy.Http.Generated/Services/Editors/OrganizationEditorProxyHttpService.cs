namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class OrganizationEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.Organization, OrganizationEditorModel>,  IOrganizationEditorService
    {                

        public OrganizationEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "OrganizationEditor";
    }
}
