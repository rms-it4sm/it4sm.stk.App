namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class OrdersEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.Zakaz, OrdersEditorModel>,  IOrdersEditorService
    {                

        public OrdersEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "OrdersEditor";
    }
}
