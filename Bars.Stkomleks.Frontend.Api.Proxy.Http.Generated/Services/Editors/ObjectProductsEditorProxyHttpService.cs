namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class ObjectProductsEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.ObjectProducts, ObjectProductsEditorModel>,  IObjectProductsEditorService
    {                

        public ObjectProductsEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "ObjectProductsEditor";
    }
}
