namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class ProductsEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.Products, ProductsEditorModel>,  IProductsEditorService
    {                

        public ProductsEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "ProductsEditor";
    }
}
