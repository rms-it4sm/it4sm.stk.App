namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class ObjectsTypesEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.ObjectsTypes, ObjectsTypesEditorModel>,  IObjectsTypesEditorService
    {                

        public ObjectsTypesEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "ObjectsTypesEditor";
    }
}
