namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class DepartmentsEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.Departments, DepartmentsEditorModel>,  IDepartmentsEditorService
    {                

        public DepartmentsEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "DepartmentsEditor";
    }
}
