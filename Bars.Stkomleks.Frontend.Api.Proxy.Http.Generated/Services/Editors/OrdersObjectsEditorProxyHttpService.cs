namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class OrdersObjectsEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.OrdersObjects, OrdersObjectsEditorModel>,  IOrdersObjectsEditorService
    {                

        public OrdersObjectsEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "OrdersObjectsEditor";
    }
}
