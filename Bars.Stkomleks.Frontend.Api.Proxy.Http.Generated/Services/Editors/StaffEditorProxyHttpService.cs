namespace Bars.Stkomleks
{
    ...
    /// </summary>
    public class StaffEditorHttpProxyService : EditorViewServiceHttpProxy<Bars.Stkomleks.Staff, StaffEditorModel>,  IStaffEditorService
    {                

        public StaffEditorHttpProxyService(IWindsorContainer container)
            :base(container, container.Resolve<FrontendHttpProxyConfig>())
        {
        }

        protected override string ControllerName => "StaffEditor";
    }
}
