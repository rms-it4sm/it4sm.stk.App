...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Единицы измерения")]
	    public class UnitMeasureListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.UnitMeasure, Bars.Stkomleks.UnitMeasureListModel>, IUnitMeasureListService
    {                                  
        public UnitMeasureListHttpProxyService(IWindsorContainer container) 
        ...
        protected override string ControllerName => "UnitMeasureList";
    }
}