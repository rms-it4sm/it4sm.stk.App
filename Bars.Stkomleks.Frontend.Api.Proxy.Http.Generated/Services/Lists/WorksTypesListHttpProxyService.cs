...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Виды работ")]
	    public class WorksTypesListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.WorksTypes, Bars.Stkomleks.WorksTypesListModel>, IWorksTypesListService
    {                                  
        public WorksTypesListHttpProxyService(IWindsorContainer container) 
        ...
        protected override string ControllerName => "WorksTypesList";
    }
}