...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Сотрудники.Организация")]
	    public class StaffListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Staff, Bars.Stkomleks.StaffListModel>, IStaffListService
    {                                  
        public StaffListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "StaffList";
    }
}