...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Организации.Заказ")]
	    public class OrderOrganizationListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.OrderOrganization, Bars.Stkomleks.OrderOrganizationListModel>, IOrderOrganizationListService
    {                                  
        public OrderOrganizationListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "OrderOrganizationList";
    }
}