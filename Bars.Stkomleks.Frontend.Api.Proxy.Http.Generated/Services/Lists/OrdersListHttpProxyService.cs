...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Заказы")]
	    public class OrdersListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Zakaz, Bars.Stkomleks.OrdersListModel>, IOrdersListService
    {                                  
        public OrdersListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "OrdersList";
    }
}