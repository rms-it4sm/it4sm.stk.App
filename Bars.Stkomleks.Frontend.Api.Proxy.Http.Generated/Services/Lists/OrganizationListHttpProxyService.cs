...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Организации")]
	    public class OrganizationListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Organization, Bars.Stkomleks.OrganizationListModel>, IOrganizationListService
    {                                  
        public OrganizationListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "OrganizationList";
    }
}