...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Комплектация.Элемент спецификации")]
	    public class ProductsListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Products, Bars.Stkomleks.ProductsListModel>, IProductsListService
    {                                  
        public ProductsListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "ProductsList";
    }
}