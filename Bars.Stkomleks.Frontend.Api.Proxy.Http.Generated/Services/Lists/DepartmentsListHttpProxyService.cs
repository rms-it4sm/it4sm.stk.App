...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Подразделения.Организация")]
	    public class DepartmentsListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Departments, Bars.Stkomleks.DepartmentsListModel>, IDepartmentsListService
    {                                  
        public DepartmentsListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "DepartmentsList";
    }
}