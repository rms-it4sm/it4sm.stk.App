...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Программы.Организация")]
	    public class OrganizationFundingProgramsListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.OrganizationFundingPrograms, Bars.Stkomleks.OrganizationFundingProgramsListModel>, IOrganizationFundingProgramsListService
    {                                  
        public OrganizationFundingProgramsListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "OrganizationFundingProgramsList";
    }
}