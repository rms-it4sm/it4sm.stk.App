...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Физические лица")]
	    public class IndividualsListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.Individuals, Bars.Stkomleks.IndividualsListModel>, IIndividualsListService
    {                                  
        public IndividualsListHttpProxyService(IWindsorContainer container) 
...
foreach (var itm in elements)
{
    switch (itm._TypeUid)
    {
        ...
        protected override string ControllerName => "IndividualsList";
    }
}