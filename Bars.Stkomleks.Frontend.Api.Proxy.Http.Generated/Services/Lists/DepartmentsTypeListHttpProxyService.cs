...
namespace Bars.Stkomleks
{
	...
	[BarsUp.Utils.DisplayAttribute("Виды подразделений")]
	    public class DepartmentsTypeListHttpProxyService : ListViewServiceHttpProxy<Bars.Stkomleks.DepartmentsType, Bars.Stkomleks.DepartmentsTypeListModel>, IDepartmentsTypeListService
    {                                  
        public DepartmentsTypeListHttpProxyService(IWindsorContainer container) 
        ...
        protected override string ControllerName => "DepartmentsTypeList";
    }
}