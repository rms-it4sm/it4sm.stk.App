...
using Bars.Stkomleks.Frontend.Abstractions.Generated;
    ...
    /// </summary>
    public class OrganizationProfilesListMultiAddByOrganizationEditorService : MultiEditorViewService<Bars.Stkomleks.OrganizationProfiles, OrganizationProfilesListMultiAddByOrganizationEditorModel>,  IOrganizationProfilesListMultiAddByOrganizationEditorService
    {                

        public OrganizationProfilesListMultiAddByOrganizationEditorService(IWindsorContainer container)
            :base(container)
        {
        }
        ...
        /// </summary>
        protected override async Task<OrganizationProfilesListMultiAddByOrganizationEditorModel> CreateModelInternalAsync(BaseParams @params, CancellationToken cancellationToken)
        {
            await Task.CompletedTask;
            var model = new OrganizationProfilesListMultiAddByOrganizationEditorModel();			
var varOrganizationId = @params.JsonData.GetAs<long?>("Organization_Id");
        ...
        /// <summary>
        /// Преобразование сущности 'Организации по профилю' в модель представления
        /// </summary>
        protected override async Task<OrganizationProfilesListMultiAddByOrganizationEditorModel> MapEntityInternalAsync(Bars.Stkomleks.OrganizationProfiles entity, BaseParams baseParams, CancellationToken cancellationToken)
        {
            await Task.CompletedTask;
...
model.Id = entity.Id;
        ...
        /// <summary>
        /// Восстановление сущности 'Организации по профилю' из модели представления		
        /// </summary>
        protected override async Task UnmapEntityInternalAsync(Bars.Stkomleks.OrganizationProfiles entity, OrganizationProfilesListMultiAddByOrganizationEditorModel model, IDictionary<string, FileData> requestFiles, IList<BarsUp.Modules.FileStorage.FileInfo> filesToDelete, CancellationToken cancellationToken, BaseParams baseParams, bool isNested = false)
        {            
            await Task.CompletedTask;
        ...
        protected override async Task SaveInnerEditorsInternalAsync(Bars.Stkomleks.OrganizationProfiles entity, OrganizationProfilesListMultiAddByOrganizationEditorModel model,
